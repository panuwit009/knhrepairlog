...
<body>
    ...
    <!-- ส่วนล่าง -->
        <div class="grid grid-cols-12 gap-6 p-4 bg-light-green rounded-lg h-full">

                <div class="col-span-3 bg-gradient-to-br from-sky-400 to-sky-600 p-6 rounded-lg shadow-lg z-7">
                    <div class="text-center text-3xl font-medium text-black mb-6 bg-white rounded-lg p-4">
                        <i class="fa-solid fa-user mr-2"></i>รวมผู้ป่วยจำแนกกลุ่ม
                    </div>
                ...
                <div class="dashboard-card p-4 mt-4">
                    ...
                    <div class="text-lg mt-[50px] font-medium text-gray-800 text-center"><i class="fa-solid fa-hand-holding-medical text-white text-[60px]"></i></div>
            </div>
        ...
        <div class="col-span-3 z-9">
            <div class="dashboard-card h-full">
                <div class="overflow-auto max-h-[600px]">
                    <table class="min-w-full">
                        <thead class="sticky top-0">
                            <tr>
                                <th class="py-3 px-4 text-center text-white font-medium"><i class="fa-solid fa-hospital mr-2"></i>หอผู้ป่วยสามัญ</th>
                                <th class="py-3 px-4 text-center text-white font-medium"><i class="fa-solid fa-bed mr-2"></i>จำนวนเตียง</th>
                                <th class="py-3 px-4 text-center text-white font-medium"><i class="fa-solid fa-heart mr-2"></i>นอนรักษา</th>
                            </tr>
                        </thead>
                        <tbody>
                    <?php
            ...
            <div class="col-span-3">
                ...
                <div class="title-card relative flex bg-white rounded-full items-center justify-center text-center p-6 drop-shadow-sm overflow-hidden border-t-[6px] border-l-[4px] border-t-green-800 border-l-green-800">
                ...
                <div class="overflow-auto max-h-[400px]">
                    <table class="min-w-full">
                        <thead class="sticky top-0">
                            <tr>
                                <th class="py-3 px-4 text-center text-white font-medium"><i class="fa-solid fa-hospital mr-2"></i>หอผู้ป่วย ICU</th>
                                <th class="py-3 px-4 text-center text-white font-medium"><i class="fa-solid fa-bed mr-2"></i>จำนวนเตียง</th>
                                <th class="py-3 px-4 text-center text-white font-medium"><i class="fa-solid fa-heart mr-2"></i>นอนรักษา</th>
                            </tr>
                        </thead>
 ...
 <!-- ตารางที่ 3: Ventilator -->
        ...
        <div class="dashboard-card h-full">
            <div class="overflow-auto max-h-[600px]">
                <table class="min-w-full">
                    <thead class="sticky top-0">
                    <tr>
    <th class="py-3 px-4 text-center text-white font-medium w-2/4">หน่วยงาน</th>
    ...
    <th class="py-3 px-4 text-center text-white font-medium w-1/4">Ventilator(ยืม)</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            <td class="py-2 px-4 text-[10.60px] text-gray-700 w-1/4"><?php echo $row['unit']; ?></td>
