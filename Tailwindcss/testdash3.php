...
<div class="grid grid-rows-[auto_1fr] gap-4 min-h-screen bg-gray-200">
  ...
  <!-- Top section -->
  <div class="grid grid-cols-1 md:grid-cols-12 gap-4 bg-light-green p-3 h-[900px] md:h-[260px]">
  ...
  <div class="grid grid-cols-1 md:grid-cols-12 gap-3 p-3 bg-light-green rounded-lg">
    ...
    <div class="col-span-1 md:col-span-3 bg-gradient-to-br from-sky-400 to-sky-600 gap-3 px-[12px] py-3 rounded-lg shadow-lg">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
        ...
        <div class="dashboard-card px-2 py-2 flex rounded-md shadow-md overflow-hidden">
          <div class="flex items-center justify-center">
            <i class="fa-solid fa-stethoscope text-gray-800 text-[12px] md:text-[13px] px-2"></i>
          </div>
          <div class="pl-3 py-3 flex flex-col justify-center">
            <p class="text-[11px] md:text-[12px] font-medium text-gray-800">จำนวนผู้ป่วยห้องตรวจนอกเวลา</p>
            <p class="text-[18px] md:text-[20px] font-bold text-gray-900 mt-2">เช้านอกเวลา  </p>
            <p class="text-[18px] md:text-[20px] font-bold text-gray-900"> <?php echo $totalOuttimeMorning ? $totalOuttimeMorning : '0'; ?> ราย</p>
            <p class="text-[18px] md:text-[20px] font-bold text-gray-900 mt-2">บ่ายนอกเวลา  </p>
            <p class="text-[18px] md:text-[20px] font-bold text-gray-900"> <?php echo $totalOuttimeAfternoon ? $totalOuttimeAfternoon : '0'; ?> ราย</p>
          </div>
        </div>

        <div class="dashboard-card px-2 py-2 flex rounded-md shadow-md overflow-hidden">
          <div class="flex items-center justify-center">
            <i class="fa-solid fa-hospital-user text-gray-800 text-[12px] md:text-[13px] px-2"></i>
          </div>
          <div class="pl-3 py-3 flex flex-col justify-center">
            <p class="text-[11px] md:text-[12px] font-medium text-gray-800">ผู้ป่วยโควิด 19 ที่หอผู้ป่วยติดเชื้อแยกโรค</p>
            <h3 class="text-[18px] md:text-[20px] font-bold text-gray-900 mt-2"><?php echo $countcovid; ?> ราย</h3>
            <p class="text-gray-600 text-[10px] md:text-sm mt-2">อัพเดตข้อมูลล่าสุด </p>
        <p class="text-[11px] md:text-[13px] mt-2">วัน<?= $where_date ?></p>
          <p class="text-[11px] md:text-[13px] mt-2"> เวร : <?= $current_shift ?></p>          </div>
        </div>

        <div class="col-span-2 dashboard-card px-2 py-2 rounded-lg shadow-md">
  <!-- Content section -->
  <div class="flex-1 pl-2 py-2">
    ...
    <div class="grid grid-cols-2 gap-4 mt-3">
      ...
      <div class="flex flex-col items-center">
        <p class="text-[10px] md:text-sm text-center text-gray-600">
          <span class="font-semibold text-gray-800">นอกเวลา(8.30-12.30)</span>
        </p>
        <p class="text-[16px] md:text-xl font-bold text-gray-800 mt-1 text-center">
          <?php echo $totalErMorning ? $totalErMorning : '0'; ?> ราย
        </p>
        <p class="text-[10px] mt-2 md:text-[12px]"><strong>หมายเหตุ (เช้านอกเวลา):</strong> </P>
        <p class="text-[10px] mt-2 md:text-[12px]"> <?php echo $reportReasonMorning ? $reportReasonMorning : 'ไม่มีข้อมูล'; ?></p>
      </div>
      
      <!-- Afternoon section -->
      <div class="flex flex-col items-center">
        <p class="text-[10px] md:text-sm text-center text-gray-600">
          <span class="font-semibold text-gray-800">นอกเวลา(16.30-20.30)</span>
        </p>
        <p class="text-[16px] md:text-xl font-bold text-gray-800 mt-1 text-center">
          <?php echo $totalErAfternoon ? $totalErAfternoon : '0';?> ราย
        </p>
        <p class="text-[10px] mt-2 md:text-[12px]"><strong>หมายเหตุ (บ่ายนอกเวลา):</strong> </p>
        <p class="text-[10px] mt-2 md:text-[12px]"><?php echo $reportReasonAfternoon ? $reportReasonAfternoon : 'ไม่มีข้อมูล'; ?></p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="overflow-auto max-h-[300px] md:max-h-[600px]">
    ...
    <p class="text-center absolute bottom-6 left-0 right-0 pb-2"><strong>วัน<?= $thaiTime ?></strong></p> 
</div>
      </div>
    </div>
