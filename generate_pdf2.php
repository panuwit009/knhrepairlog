...
try {
    ...
    $stmt = $pdo->prepare("SELECT r.id, r.sender_name, r.ward, r.equipment, r.eq_no, r.eq_status, r.rtimestamp, 
    ...
    // ตั้งค่า watermark
    $mpdf->SetWatermarkImage('Logo-2-removebg-preview.png', 0.05);
...
<div class="cols-3"> 
    ...
    <div class="container">
        ...
        <div class="cols-6" style="padding: 7px 10px;">
            ...
            <strong class="font-strong">เลข IT : </strong><br>
    ...
    <div class="container-top">
        ...
        <div class="cols-12" style="padding: 7px 10px;">
            ...
            <div class="cols-2">
                <input type="checkbox">
                <label>ส่งซ่อมเครื่องปริ้น</label>
            </div>

            <div class="cols-3">
                <input type="checkbox">
                <label>ส่งซ่อมเครื่องคอมพิวเตอร์</label>
            </div>
    ...
    <div class="container-top">
        ...
        <div class="cols-6" style="padding: 7px 10px; width: auto;">
                ...
                <div style="text-align: right;">
                    <label> <?php echo $sign,$point; ?> </label><br>
                    <label>(นางสาว วิชชุดา แก่นเพ็ชร์)</label><br>
                    <label>ตำแหน่ง เจ้าพนักงานพัสดุ</label><br>
                    <label> <?php echo $dates,$point; ?> </label><br>
                </div>
            </div> 
        ...
        <div class="container-top">
            ...
            <div class="cols-12" style="padding: 7px 10px; width: auto;">
                <label><strong class="font-strong">บริษัท</strong></label><br>
                <label>วันที่ส่งซ่อมบริษัท<?php echo $point ?></label><br>
                <label>ลงชื่อบริษัท<?php echo $point ?></label><br>
                <label>เทคโนโลยีสารสนเทศ : รับครุภัณฑ์</label><br>
